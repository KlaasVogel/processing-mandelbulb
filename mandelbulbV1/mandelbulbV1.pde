...
//in the first test I will try to look at a point and see if it's finite (value in matrix is zero) and has any neigbours who is infinite (one)
//the iteration does not include the border for simplicity 
boolean checkMatrix(int i, int j, int k){
